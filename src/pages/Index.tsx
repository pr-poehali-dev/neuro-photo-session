        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="group hover:shadow-xl transition-all duration-300">
              <CardHeader>
                <div className="w-12 h-12 bg-ai-blue/10 rounded-lg flex items-center justify-center mb-4">
                  <Icon name="Brain" size={24} className="text-ai-blue" />
                </div>
                <CardTitle className="text-xl font-heading">Что такое нейрофотосессия?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Современный способ создания уникальных фотографий с помощью искусственного интеллекта. 
                  AI анализирует ваши исходные снимки и создает профессиональные портреты в любом стиле.
                </p>
                <Button variant="outline" className="w-full group-hover:bg-ai-blue group-hover:text-white transition-colors">
            ...
            <Card className="group hover:shadow-xl transition-all duration-300">
              <CardHeader>
                <div className="w-12 h-12 bg-ai-purple/10 rounded-lg flex items-center justify-center mb-4">
                  <Icon name="Palette" size={24} className="text-ai-purple" />
                </div>
                <CardTitle className="text-xl font-heading">Как выбрать стиль?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
                  От классических портретов до футуристических образов - мы поможем подобрать стиль, 
                  который подчеркнет вашу индивидуальность и соответствует вашим целям.
                </p>
                <Button variant="outline" className="w-full group-hover:bg-ai-purple group-hover:text-white transition-colors">
                  <Icon name="ArrowRight" size={16} className="mr-2" />
                  Читать далее
                </Button>
              </CardContent>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300">
              <CardHeader>
                <div className="w-12 h-12 bg-neural/10 rounded-lg flex items-center justify-center mb-4">
                  <Icon name="Briefcase" size={24} className="text-neural" />
                </div>
                <CardTitle className="text-xl font-heading">Нейрофото для бизнеса</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Идеальное решение для создания корпоративных портретов, рекламных материалов 
                  и контента для социальных сетей. Профессиональный результат за 24 часа.
                </p>
                <Button variant="outline" className="w-full group-hover:bg-neural group-hover:text-white transition-colors">
                  <Icon name="ArrowRight" size={16} className="mr-2" />
                  Читать далее
                </Button>
              </CardContent>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "Невероятно! AI создал фотографии, которые выглядят лучше профессиональной студийной съёмки. 
                  Коллеги не поверили, что это нейросеть."
                </p>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-ai-blue/20 rounded-full flex items-center justify-center mr-3">
                    <Icon name="User" size={20} className="text-ai-blue" />
                  </div>
                  <div>
                    <p className="font-heading font-semibold">Анна Петрова</p>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "Заказывал корпоративные фото для команды. За один день получили 30 профессиональных портретов. 
                  Сэкономили время и бюджет!"
                </p>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-ai-purple/20 rounded-full flex items-center justify-center mr-3">
                    <Icon name="User" size={20} className="text-ai-purple" />
                  </div>
                  <div>
                    <p className="font-heading font-semibold">Михаил Иванов</p>
                    <p className="text-sm text-gray-600">Руководитель IT-отдела</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "Мечтала о фотосессии в стиле ретро-футуризма. Нейросеть воплотила все мои идеи! 
                  Теперь у меня есть уникальные снимки для соцсетей."
                </p>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-neural/20 rounded-full flex items-center justify-center mr-3">
                    <Icon name="User" size={20} className="text-neural" />
                  </div>
                  <div>
                    <p className="font-heading font-semibold">Елена Смирнова</p>
                    <p className="text-sm text-gray-600">Блогер</p>
                  </div>
                </div>
              </CardContent>
            </Card>
